"""SecureWipe GUI — Step 1: Operator Details"""
...
class Step1Operator(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkLabel(self, text="Please enter your operator details before starting.",
